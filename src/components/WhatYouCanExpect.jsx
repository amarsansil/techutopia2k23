    ...
    <div className=" text-sm px-2 lg:px-10 WhatYouCanExpect items-center my-5 grid grid-cols-1 lg:grid-cols-2">
      <div className="bg-slate-900 bg-opacity-30 py-5 rounded-lg px-5">
        ...
        <h3  className="font-display text-xs">
          Over 25+ events and 10+ workshops covering 6 major engineering departments
          have been organized by our team with hours of hard work and
          dedication.
          <br />
          Visit our exhibitions on future technologies like Metaverse, Blockchain and many more and immerse yourself in
